                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2" style="background: #1c1e26;">
                                    ...
                                    <?php 
                                    // Sjednocení role na malá písmena pro snazší porovnávání
                                    ...
                                    <?php if (in_array($role, ['admin', 'šéfredaktor', 'redaktor'])): ?>
                                        <li><hr class="dropdown-divider bg-secondary"></li>
                                        <li>
                                            <a class="dropdown-item text-info" href="editor_dashboard.php">
                                                <i class="fa-solid fa-list-check me-2"></i>Redakční přehled
                                            </a>
                                        </li>
                                    <?php endif; ?>

                                    <?php if (in_array($role, ['admin', 'šéfredaktor'])): ?>
                                        <li><hr class="dropdown-divider bg-secondary"></li>
                                        
                                        <li>
                                            <a class="dropdown-item text-warning" href="chief_dashboard.php">
                                                <i class="fa-solid fa-chart-line me-2"></i>Statistiky časopisu
                                            </a>
                                        </li>
